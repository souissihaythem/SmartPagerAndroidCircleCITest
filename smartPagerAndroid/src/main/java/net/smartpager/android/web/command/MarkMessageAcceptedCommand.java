...
/**
 * Mark a specific message as accepted.<br>
 * <b>Request JSON</b><br>
 * <tt>[<br>
 ...
 * @author Roman
 */
public class MarkMessageAcceptedCommand extends AbstractUserCommand {

	private static final long serialVersionUID = 3022167209096488040L;
	...
	public AbstractResponse getResponse(String string) {
		...
		if(responce.isSuccess()){
			...
			values.put(MessageTable.status.name(), MessageStatus.Accepted.name());
			values.put(MessageTable.messageStatus.name(), MessageStatus.Accepted.name());
	...
	public WebAction getWebAction() {
		return WebAction.markMessageAccepted;
	}
