...
import net.smartpager.android.fragment.interfaces.IDisposable;

public class CropImageViewTouch extends ImageView implements IDisposable {
	...
	final protected CropRotateBitmap		mBitmapDisplayed	= new CropRotateBitmap( null, 0 );
	...
	public CropImageViewTouch( Context context, AttributeSet attrs )
	{
		super( context, attrs );
		init();
	}
	...
	{
		setImageRotateBitmapReset( new CropRotateBitmap( bitmap, 0 ), reset );
	}
	
	public void setImageBitmapReset( final Bitmap bitmap, final int rotation, final boolean reset )
	{
		setImageRotateBitmapReset( new CropRotateBitmap( bitmap, rotation ), reset );
	}
	
	public void setImageRotateBitmapReset( final CropRotateBitmap bitmap, final boolean reset )	{
	...
	protected float maxZoom()
	{
		...
		float max = Math.max(Math.max( fw, fh ) * 4,1F);
		return max;*/
		return 20f;
	}
	
	public CropRotateBitmap getDisplayBitmap()
	{
	 ...
	 * @param matrix
	 */
	protected void getProperBaseMatrix( CropRotateBitmap bitmap, Matrix matrix )
	{
