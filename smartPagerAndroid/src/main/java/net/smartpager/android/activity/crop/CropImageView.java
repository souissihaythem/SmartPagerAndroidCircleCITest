...
public class CropImageView extends CropImageViewTouch {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mHighlightViews.size(); i++) {
            mHighlightViews.get(i).draw(canvas,getWidth(),getHeight());
            
        }
        canvas.drawPath(p, mFocusPaint);
    }
